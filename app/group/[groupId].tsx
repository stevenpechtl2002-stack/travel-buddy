...
const styles = StyleSheet.create({
  ...
  planCard: { backgroundColor: 'rgba(0,0,0,0.45)', borderRadius: 18, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)' },
  ...
  actCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.4)', borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)' },
  actTitle: { fontSize: 14, fontWeight: '700', color: '#fff' },
  actMeta: { fontSize: 12, color: 'rgba(255,255,255,0.55)', marginTop: 2 },
  addActCard: { backgroundColor: 'rgba(0,0,0,0.4)', borderRadius: 16, padding: 14, marginTop: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)' },
  membersContent: { padding: spacing.lg, paddingBottom: 100 },
  memberRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.4)', borderRadius: 14, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)' },
