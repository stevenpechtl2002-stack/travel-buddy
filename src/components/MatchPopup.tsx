    ...
    <Modal visible={visible} transparent animationType="fade" accessibilityViewIsModal>
      <View style={styles.overlay}>
        <LinearGradient colors={[colors.primary, colors.primaryLight]} style={styles.card}>
          ...
          <Text style={styles.subtitle}>Ihr und {matchName} reist in die gleiche Richtung!</Text>
          <Pressable style={styles.chatButton} onPress={onStartChat}
            accessibilityLabel="Jetzt chatten" accessibilityRole="button">
            <Text style={styles.chatButtonText}>💬 Jetzt chatten</Text>
          </Pressable>
          <Pressable onPress={onClose}
            accessibilityLabel="Weiter swipen" accessibilityRole="button">
...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: radius.lg, padding: spacing.xl, alignItems: 'center', width: '100%' },
  ...
  chatButton: { backgroundColor: '#fff', borderRadius: radius.md, padding: spacing.md,
